...
from api_msgs.srv import LaunchCmd, LaunchCmdResponse
...
class RosLaunchApi():
    def __init__(self, base_path):
        ...
        self.cmd_list = {"start_mapping": "roslaunch cartographer_ros my_revo_lds.launch",
                         ...
                         "start_total_map_server": "rosrun map_server map_server "
                         }
        rospy.Service("api/remote_launch", LaunchCmd, self.handle_savemap)
    ...
    def handle_savemap(self, req):
        ...
        if req.cmd == "start_mapping":
            ...
            for mm in map_list:
                k = k+1
                nn = mm.split('.')[0]
                subprocess.Popen( cmd + self.base_path + 'maps/' + mm +
