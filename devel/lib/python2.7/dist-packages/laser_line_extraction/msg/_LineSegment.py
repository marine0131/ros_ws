...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2f.pack(_x.radius, _x.angle))
      buff.write(_struct_4f.pack(*self.covariance))
      buff.write(_struct_2f.pack(*self.start))
      buff.write(_struct_2f.pack(*self.end))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.radius, _x.angle,) = _struct_2f.unpack(str[start:end])
      start = end
      end += 16
      self.covariance = _struct_4f.unpack(str[start:end])
      start = end
      end += 8
      self.start = _struct_2f.unpack(str[start:end])
      start = end
      end += 8
      self.end = _struct_2f.unpack(str[start:end])
      return self
