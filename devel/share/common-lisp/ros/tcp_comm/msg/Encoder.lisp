...
(cl:defmethod cl:initialize-instance :after ((m <Encoder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tcp_comm-msg:<Encoder> is deprecated: use tcp_comm-msg:Encoder instead.")))

(cl:ensure-generic-function 'leftEncoder-val :lambda-list '(m))
(cl:defmethod leftEncoder-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcp_comm-msg:leftEncoder-val is deprecated.  Use tcp_comm-msg:leftEncoder instead.")
  (leftEncoder m))

(cl:ensure-generic-function 'rightEncoder-val :lambda-list '(m))
(cl:defmethod rightEncoder-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcp_comm-msg:rightEncoder-val is deprecated.  Use tcp_comm-msg:rightEncoder instead.")
  (rightEncoder m))

(cl:ensure-generic-function 'vx-val :lambda-list '(m))
(cl:defmethod vx-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcp_comm-msg:vx-val is deprecated.  Use tcp_comm-msg:vx instead.")
  (vx m))

(cl:ensure-generic-function 'w-val :lambda-list '(m))
(cl:defmethod w-val ((m <Encoder>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tcp_comm-msg:w-val is deprecated.  Use tcp_comm-msg:w instead.")
  (w m))
