...
(cl:defmethod cl:initialize-instance :after ((m <GridPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GridPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_tutorial-msg:<GridPoint> is deprecated: use my_tutorial-msg:GridPoint instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <GridPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-msg:x-val is deprecated.  Use my_tutorial-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <GridPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-msg:y-val is deprecated.  Use my_tutorial-msg:y instead.")
  (y m))
