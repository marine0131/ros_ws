...
(cl:defmethod cl:initialize-instance :after ((m <Ultrasound>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Ultrasound)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_tutorial-msg:<Ultrasound> is deprecated: use my_tutorial-msg:Ultrasound instead.")))

(cl:ensure-generic-function 'ultra_1-val :lambda-list '(m))
(cl:defmethod ultra_1-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-msg:ultra_1-val is deprecated.  Use my_tutorial-msg:ultra_1 instead.")
  (ultra_1 m))

(cl:ensure-generic-function 'ultra_2-val :lambda-list '(m))
(cl:defmethod ultra_2-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-msg:ultra_2-val is deprecated.  Use my_tutorial-msg:ultra_2 instead.")
  (ultra_2 m))

(cl:ensure-generic-function 'ultra_3-val :lambda-list '(m))
(cl:defmethod ultra_3-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-msg:ultra_3-val is deprecated.  Use my_tutorial-msg:ultra_3 instead.")
  (ultra_3 m))

(cl:ensure-generic-function 'ultra_4-val :lambda-list '(m))
(cl:defmethod ultra_4-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-msg:ultra_4-val is deprecated.  Use my_tutorial-msg:ultra_4 instead.")
  (ultra_4 m))

(cl:ensure-generic-function 'ultra_5-val :lambda-list '(m))
(cl:defmethod ultra_5-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-msg:ultra_5-val is deprecated.  Use my_tutorial-msg:ultra_5 instead.")
  (ultra_5 m))

(cl:ensure-generic-function 'ultra_6-val :lambda-list '(m))
(cl:defmethod ultra_6-val ((m <Ultrasound>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-msg:ultra_6-val is deprecated.  Use my_tutorial-msg:ultra_6 instead.")
  (ultra_6 m))
