...
(cl:defmethod cl:initialize-instance :after ((m <NavGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_tutorial-msg:<NavGoal> is deprecated: use my_tutorial-msg:NavGoal instead.")))

(cl:ensure-generic-function 'mapName-val :lambda-list '(m))
(cl:defmethod mapName-val ((m <NavGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-msg:mapName-val is deprecated.  Use my_tutorial-msg:mapName instead.")
  (mapName m))

(cl:ensure-generic-function 'goalName-val :lambda-list '(m))
(cl:defmethod goalName-val ((m <NavGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-msg:goalName-val is deprecated.  Use my_tutorial-msg:goalName instead.")
  (goalName m))
