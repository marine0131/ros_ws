...
(cl:defmethod cl:initialize-instance :after ((m <Sonar>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Sonar)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_tutorial-msg:<Sonar> is deprecated: use my_tutorial-msg:Sonar instead.")))

(cl:ensure-generic-function 'ranges-val :lambda-list '(m))
(cl:defmethod ranges-val ((m <Sonar>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-msg:ranges-val is deprecated.  Use my_tutorial-msg:ranges instead.")
  (ranges m))
