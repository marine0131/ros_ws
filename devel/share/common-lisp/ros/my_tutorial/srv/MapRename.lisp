...
(cl:defmethod cl:initialize-instance :after ((m <MapRename-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapRename-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_tutorial-srv:<MapRename-request> is deprecated: use my_tutorial-srv:MapRename-request instead.")))

(cl:ensure-generic-function 'oldName-val :lambda-list '(m))
(cl:defmethod oldName-val ((m <MapRename-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-srv:oldName-val is deprecated.  Use my_tutorial-srv:oldName instead.")
  (oldName m))
...
(cl:defmethod cl:initialize-instance :after ((m <MapRename-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapRename-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_tutorial-srv:<MapRename-response> is deprecated: use my_tutorial-srv:MapRename-response instead.")))
