...
(cl:defmethod cl:initialize-instance :after ((m <AddGoal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddGoal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_tutorial-srv:<AddGoal-request> is deprecated: use my_tutorial-srv:AddGoal-request instead.")))
...
(cl:defmethod goalName-val ((m <AddGoal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-srv:goalName-val is deprecated.  Use my_tutorial-srv:goalName instead.")
  (goalName m))
...
(cl:defmethod cl:initialize-instance :after ((m <AddGoal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddGoal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_tutorial-srv:<AddGoal-response> is deprecated: use my_tutorial-srv:AddGoal-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <AddGoal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_tutorial-srv:res-val is deprecated.  Use my_tutorial-srv:res instead.")
  (res m))
