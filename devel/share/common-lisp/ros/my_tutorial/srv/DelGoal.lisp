...
(cl:defmethod cl:initialize-instance :after ((m <DelGoal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DelGoal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_tutorial-srv:<DelGoal-request> is deprecated: use my_tutorial-srv:DelGoal-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <DelGoal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DelGoal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_tutorial-srv:<DelGoal-response> is deprecated: use my_tutorial-srv:DelGoal-response instead.")))
