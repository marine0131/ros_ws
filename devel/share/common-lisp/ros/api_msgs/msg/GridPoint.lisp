...
(cl:defmethod cl:initialize-instance :after ((m <GridPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GridPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api_msgs-msg:<GridPoint> is deprecated: use api_msgs-msg:GridPoint instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <GridPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api_msgs-msg:x-val is deprecated.  Use api_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <GridPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api_msgs-msg:y-val is deprecated.  Use api_msgs-msg:y instead.")
  (y m))
