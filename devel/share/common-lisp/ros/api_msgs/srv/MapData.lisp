...
(cl:defmethod cl:initialize-instance :after ((m <MapData-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapData-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api_msgs-srv:<MapData-request> is deprecated: use api_msgs-srv:MapData-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <MapData-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapData-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api_msgs-srv:<MapData-response> is deprecated: use api_msgs-srv:MapData-response instead.")))

(cl:ensure-generic-function 'mapHeight-val :lambda-list '(m))
(cl:defmethod mapHeight-val ((m <MapData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api_msgs-srv:mapHeight-val is deprecated.  Use api_msgs-srv:mapHeight instead.")
  (mapHeight m))

(cl:ensure-generic-function 'mapWidth-val :lambda-list '(m))
(cl:defmethod mapWidth-val ((m <MapData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api_msgs-srv:mapWidth-val is deprecated.  Use api_msgs-srv:mapWidth instead.")
  (mapWidth m))
