...
(cl:defmethod laserPoint-val ((m <GridLaser-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api_msgs-srv:laserPoint-val is deprecated.  Use api_msgs-srv:laserPoint instead.")
  (laserPoint m))

(cl:ensure-generic-function 'mapGridWidth-val :lambda-list '(m))
(cl:defmethod mapGridWidth-val ((m <GridLaser-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api_msgs-srv:mapGridWidth-val is deprecated.  Use api_msgs-srv:mapGridWidth instead.")
  (mapGridWidth m))

(cl:ensure-generic-function 'mapGridHeight-val :lambda-list '(m))
(cl:defmethod mapGridHeight-val ((m <GridLaser-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api_msgs-srv:mapGridHeight-val is deprecated.  Use api_msgs-srv:mapGridHeight instead.")
  (mapGridHeight m))

(cl:ensure-generic-function 'mapResolution-val :lambda-list '(m))
(cl:defmethod mapResolution-val ((m <GridLaser-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api_msgs-srv:mapResolution-val is deprecated.  Use api_msgs-srv:mapResolution instead.")
  (mapResolution m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GridLaser-response>)))
  ...
  (cl:format cl:nil "GridPoint[] laserPoint~%int32 mapGridWidth~%int32 mapGridHeight~%float32 mapResolution~%string msg~%~%~%================================================================================~%MSG: api_msgs/GridPoint~%int32 x~%int32 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GridLaser-response)))
  "Returns full string definition for message of type 'GridLaser-response"
  (cl:format cl:nil "GridPoint[] laserPoint~%int32 mapGridWidth~%int32 mapGridHeight~%float32 mapResolution~%string msg~%~%~%================================================================================~%MSG: api_msgs/GridPoint~%int32 x~%int32 y~%~%~%"))
