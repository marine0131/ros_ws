...
(cl:defmethod cl:initialize-instance :after ((m <MapData-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapData-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<MapData-request> is deprecated: use api-srv:MapData-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <MapData-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:name-val is deprecated.  Use api-srv:name instead.")
  (name m))
...
(cl:defmethod cl:initialize-instance :after ((m <MapData-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapData-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<MapData-response> is deprecated: use api-srv:MapData-response instead.")))

(cl:ensure-generic-function 'mapHeight-val :lambda-list '(m))
(cl:defmethod mapHeight-val ((m <MapData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:mapHeight-val is deprecated.  Use api-srv:mapHeight instead.")
  (mapHeight m))

(cl:ensure-generic-function 'mapWidth-val :lambda-list '(m))
(cl:defmethod mapWidth-val ((m <MapData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:mapWidth-val is deprecated.  Use api-srv:mapWidth instead.")
  (mapWidth m))

(cl:ensure-generic-function 'base64Data-val :lambda-list '(m))
(cl:defmethod base64Data-val ((m <MapData-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:base64Data-val is deprecated.  Use api-srv:base64Data instead.")
  (base64Data m))
