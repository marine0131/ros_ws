...
(cl:defmethod cl:initialize-instance :after ((m <GridPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GridPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<GridPose-request> is deprecated: use api-srv:GridPose-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GridPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GridPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<GridPose-response> is deprecated: use api-srv:GridPose-response instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <GridPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:pose-val is deprecated.  Use api-srv:pose instead.")
  (pose m))

(cl:ensure-generic-function 'head-val :lambda-list '(m))
(cl:defmethod head-val ((m <GridPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:head-val is deprecated.  Use api-srv:head instead.")
  (head m))
