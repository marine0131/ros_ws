...
(cl:defmethod cl:initialize-instance :after ((m <LaunchCmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaunchCmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<LaunchCmd-request> is deprecated: use api-srv:LaunchCmd-request instead.")))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <LaunchCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:cmd-val is deprecated.  Use api-srv:cmd instead.")
  (cmd m))
...
(cl:defmethod cl:initialize-instance :after ((m <LaunchCmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaunchCmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<LaunchCmd-response> is deprecated: use api-srv:LaunchCmd-response instead.")))
