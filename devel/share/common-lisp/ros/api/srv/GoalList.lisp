...
(cl:defmethod cl:initialize-instance :after ((m <GoalList-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoalList-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<GoalList-request> is deprecated: use api-srv:GoalList-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GoalList-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GoalList-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<GoalList-response> is deprecated: use api-srv:GoalList-response instead.")))

(cl:ensure-generic-function 'goalList-val :lambda-list '(m))
(cl:defmethod goalList-val ((m <GoalList-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:goalList-val is deprecated.  Use api-srv:goalList instead.")
  (goalList m))
