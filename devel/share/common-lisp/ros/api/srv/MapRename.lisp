...
(cl:defmethod cl:initialize-instance :after ((m <MapRename-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapRename-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<MapRename-request> is deprecated: use api-srv:MapRename-request instead.")))

(cl:ensure-generic-function 'oldName-val :lambda-list '(m))
(cl:defmethod oldName-val ((m <MapRename-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:oldName-val is deprecated.  Use api-srv:oldName instead.")
  (oldName m))
...
(cl:defmethod cl:initialize-instance :after ((m <MapRename-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapRename-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<MapRename-response> is deprecated: use api-srv:MapRename-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <MapRename-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:result-val is deprecated.  Use api-srv:result instead.")
  (result m))
