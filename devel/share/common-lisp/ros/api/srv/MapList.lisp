...
(cl:defmethod cl:initialize-instance :after ((m <MapList-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapList-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<MapList-request> is deprecated: use api-srv:MapList-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <MapList-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapList-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<MapList-response> is deprecated: use api-srv:MapList-response instead.")))
