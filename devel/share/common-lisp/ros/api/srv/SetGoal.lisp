...
(cl:defmethod cl:initialize-instance :after ((m <SetGoal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGoal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<SetGoal-request> is deprecated: use api-srv:SetGoal-request instead.")))

(cl:ensure-generic-function 'grid_x-val :lambda-list '(m))
(cl:defmethod grid_x-val ((m <SetGoal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:grid_x-val is deprecated.  Use api-srv:grid_x instead.")
  (grid_x m))

(cl:ensure-generic-function 'grid_y-val :lambda-list '(m))
(cl:defmethod grid_y-val ((m <SetGoal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-srv:grid_y-val is deprecated.  Use api-srv:grid_y instead.")
  (grid_y m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetGoal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetGoal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-srv:<SetGoal-response> is deprecated: use api-srv:SetGoal-response instead.")))
