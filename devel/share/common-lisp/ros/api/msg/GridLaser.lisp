...
(cl:defmethod cl:initialize-instance :after ((m <GridLaser>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GridLaser)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-msg:<GridLaser> is deprecated: use api-msg:GridLaser instead.")))

(cl:ensure-generic-function 'gridPnt-val :lambda-list '(m))
(cl:defmethod gridPnt-val ((m <GridLaser>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-msg:gridPnt-val is deprecated.  Use api-msg:gridPnt instead.")
  (gridPnt m))

(cl:ensure-generic-function 'mapGridWidth-val :lambda-list '(m))
(cl:defmethod mapGridWidth-val ((m <GridLaser>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-msg:mapGridWidth-val is deprecated.  Use api-msg:mapGridWidth instead.")
  (mapGridWidth m))

(cl:ensure-generic-function 'mapGridHeight-val :lambda-list '(m))
(cl:defmethod mapGridHeight-val ((m <GridLaser>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-msg:mapGridHeight-val is deprecated.  Use api-msg:mapGridHeight instead.")
  (mapGridHeight m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GridLaser>)))
  ...
  (cl:format cl:nil "GridPoint[] gridPnt~%int32 mapGridWidth~%int32 mapGridHeight~%~%================================================================================~%MSG: api/GridPoint~%int32 x~%int32 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GridLaser)))
  "Returns full string definition for message of type 'GridLaser"
  (cl:format cl:nil "GridPoint[] gridPnt~%int32 mapGridWidth~%int32 mapGridHeight~%~%================================================================================~%MSG: api/GridPoint~%int32 x~%int32 y~%~%~%"))
