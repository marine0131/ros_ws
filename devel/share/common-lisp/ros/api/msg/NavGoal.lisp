...
(cl:defmethod cl:initialize-instance :after ((m <NavGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name api-msg:<NavGoal> is deprecated: use api-msg:NavGoal instead.")))

(cl:ensure-generic-function 'mapName-val :lambda-list '(m))
(cl:defmethod mapName-val ((m <NavGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-msg:mapName-val is deprecated.  Use api-msg:mapName instead.")
  (mapName m))

(cl:ensure-generic-function 'goalName-val :lambda-list '(m))
(cl:defmethod goalName-val ((m <NavGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader api-msg:goalName-val is deprecated.  Use api-msg:goalName instead.")
  (goalName m))
