...
(cl:defmethod cl:initialize-instance :after ((m <IntList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IntList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_tcp_comm-msg:<IntList> is deprecated: use ros_tcp_comm-msg:IntList instead.")))
