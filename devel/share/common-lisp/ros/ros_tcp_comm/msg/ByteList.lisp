...
(cl:in-package ros_tcp_comm-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ByteList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ByteList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_tcp_comm-msg:<ByteList> is deprecated: use ros_tcp_comm-msg:ByteList instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ByteList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_tcp_comm-msg:header-val is deprecated.  Use ros_tcp_comm-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <ByteList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_tcp_comm-msg:data-val is deprecated.  Use ros_tcp_comm-msg:data instead.")
  (data m))
